...
if knobs.metax.use_maca:
    # map all the libdevice.10.bc funcs to maca in maca_mathlib.bc, do not modify the specific func in libdevice.py
    # TODO(MACA): add python/triton/language/extra/maca/ directory later
    nv_to_maca_map = {
        "__nv_floorf": "mc_math_func_floorf",
        "__nv_floor": "mc_math_func_floor",
        "__nv_log2f": "mc_math_func_log2f",
        "__nv_log2": "mc_math_func_log2",
        "__nv_logf": "mc_math_func_logf",
        "__nv_log1p": "mc_math_func_log1p",
        "__nv_powf": "mc_math_func_powf_inline",
        "__nv_pow": "mc_math_func_pow",
        "__nv_norm4df": "mc_math_func_norm4df",
        "__nv_norm4d": "mc_math_func_norm4d",
        "__nv_expf": "mc_math_func_expf",
        "__nv_exp": "mc_math_func_exp",
        "__nv_ffs": "mc_math_func_ffs",
        "__nv_umulhi": "mc_math_func_umulhi",
        "__nv_umul64hi": "mc_math_func_umul64hi",
        "__nv_rsqrtf": "mc_math_func_rsqrtf",
        "__nv_erff": "mc_math_func_erff",
        "__nv_tanhf": "mc_math_func_tanhf",
        "__nv_max": "mc_math_func_max",
        "__nv_umax": "mc_math_func_umax",
        "__nv_fmaxf": "mc_math_func_fmaxf",
        "__nv_fmax": "mc_math_func_fmax",
        "__nv_llmax": "mc_math_func_llmax",
        "__nv_ullmax": "mc_math_func_ullmax",
        "__nv_min": "mc_math_func_min",
        "__nv_umin": "mc_math_func_umin",
        "__nv_fminf": "mc_math_func_fminf",
        "__nv_fmin": "mc_math_func_fmin",
        "__nv_llmin": "mc_math_func_llmin",
        "__nv_ullmin": "mc_math_func_ullmin",
        "__nv_isinff": "mc_math_func_isinff",
        "__nv_log1pf": "mc_math_func_log1pf",
        "__nv_truncf": "mc_math_func_truncf",
        "__nv_expm1f": "mc_math_func_expm1f",
        "__nv_exp2f": "mc_math_func_exp2f",
        "__nv_fmodf": "mc_math_func_fmodf",
        "__nv_lgammaf": "mc_math_func_lgammaf",
        "__nv_log": "mc_math_func_log",
        "__nv_nearbyintf": "mc_math_func_nearbyintf",
        "__nv_signbitf": "mc_math_func_signbitf",
        "__nv_tanf": "mc_math_func_tanf",
        "__nv_ceilf": "mc_math_func_ceilf",
        "__nv_acosf": "mc_math_func_acosf",
        "__nv_acoshf": "mc_math_func_acoshf",
        "__nv_acos": "mc_math_func_acos",
        "__nv_acosh": "mc_math_func_acosh",
        "__nv_asinf": "mc_math_func_asinf",
        "__nv_asin": "mc_math_func_asin",
        "__nv_asinhf": "mc_math_func_asinhf",
        "__nv_asinh": "mc_math_func_asinh",
        "__nv_atan2f": "mc_math_func_atan2f",
        "__nv_atan2": "mc_math_func_atan2",
        "__nv_atanf": "mc_math_func_atanf",
        "__nv_atan": "mc_math_func_atan",
        "__nv_atanhf": "mc_math_func_atanhf",
        "__nv_atanh": "mc_math_func_atanh",
        "__nv_erf": "mc_math_func_erf",
        "__nv_erfcf": "mc_math_func_erfcf",
        "__nv_copysignf": "mc_math_func_copysignf",
        "__nv_copysign": "mc_math_func_copysign",
        "__nv_cos": "mc_math_func_cos",
        "__nv_coshf": "mc_math_func_coshf",
        "__nv_cosh": "mc_math_func_cosh",
        "__nv_isnanf": "mc_math_func_isnanf",
        "__nv_isnand": "mc_math_func_isnan",
        "__nv_hypotf": "mc_math_func_hypotf",
        "__nv_hypot": "mc_math_func_hypot",
        "__nv_sqrt": "mc_math_func_sqrt",
        "__nv_rsqrt": "mc_math_func_rsqrt",
        "__nv_nextafterf": "mc_math_func_nextafterf",
        "__nv_nextafter": "mc_math_func_nextafter",
        "__nv_sin": "mc_math_func_sin",
        "__nv_sinhf": "mc_math_func_sinhf",
        "__nv_sinh": "mc_math_func_sinh",
        "__nv_scalbnf": "mc_math_func_scalbnf",
        "__nv_fdiv_rn": "mc_math_func_fdiv_rn",
        "__nv_fdiv_rz": "mc_math_func_fdiv_rz",
        "__nv_powif": "mc_math_func_powif_inline",
        "__nv_finitef": "mc_math_func_finitef",
        "__nv_isfinited": "mc_math_func_isfinite",
        "__nv_fast_fdividef": "mc_math_func_fdividef",
        "__nv_fast_sinf": "mc_math_func_sinf",
        "__nv_fast_cosf": "mc_math_func_cosf",
        "__nv_fast_log2f": "mc_math_func_log2f",
        "__nv_fast_logf": "mc_math_func_logf",
        "__nv_fast_expf": "mc_math_func_expf",
        "__nv_fast_tanf": "mc_math_func_tanf",
        "__nv_fast_exp10f": "mc_math_func_exp10f",
        "__nv_fast_log10f": "mc_math_func_log10f",
        "__nv_fast_powf": "mc_math_func_powf_inline",
        "__nv_rintf": "mc_math_func_rintf",
...
def fp4_to_fp_scaled(src, scale, elem_type, axis, _semantic=None):
    """
    Upcast packed fp4 (e2m1) values and multiply them by fp8 e8m0 block scales
    stored as int8 or uint8.

    Each element of :code:`src` contains two fp4 values, with the first value in
    the low 4 bits.  One :code:`scale` element applies to N packed input
    ...
    :param scale: int8 or uint8 tensor containing fp8 e8m0 bit patterns, one
                  scale per N packed input elements.
    :param elem_type: output dtype, only `tl.bfloat16` supported.
...
def inline_intrinsic_elementwise(intrinsic: str, args: Sequence, dtype: Union[dtype, Sequence[dtype]], is_pure: bool,
                                 _semantic=None):
    '''
    Apply an intrinsic function to elementwise operations.
    ...
    builder = _semantic.builder
    call = builder.create_inline_intrinsic(intrinsic, handles, [ty.to_ir(builder) for ty in res_tys], is_pure)
...
def dispatch(func, lib_name: str, lib_path: str, args: list, arg_type_symbol_dict: dict, ret_type: dtype, is_pure: bool,
    ...
    if arg_types not in arg_type_symbol_dict:
        ...
        if (knobs.metax.use_maca and arg_type_symbol_dict[arg_types][0].startswith("__nv")):
            symbol = nv_to_maca_map[arg_type_symbol_dict[arg_types][0]]
        else:
